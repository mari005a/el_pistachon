...
<head>
  ...
  <title>Registro | El Pistachón</title>
...
<body style="margin:0; font-family:'Poppins', sans-serif; background-color:#fafafa; display:flex; flex-direction:column; min-height:100vh;">
  ...
  <main style="flex:1; display:flex; justify-content:center; align-items:center;">
    <div style="width:100%; max-width:500px; background:#fff; padding:50px; border-radius:10px; box-shadow:0 3px 8px rgba(0,0,0,0.1); text-align:center;">
      <h1 style="margin-bottom:25px;">Crear cuenta</h1>
      ...
      <form action="register_action.php" method="POST" style="display:flex; flex-direction:column; gap:15px; text-align:left;">
        ...
        <div style="position:relative;">
          <i class="fas fa-envelope" style="position:absolute; left:15px; top:50%; transform:translateY(-50%); color:#666; z-index:2;"></i>
        ...
        <div style="position:relative;">
          ...
          <input type="password" name="password" id="password" placeholder="Contraseña" required 
                 style="padding:12px 45px 12px 45px; border:1px solid #ccc; border-radius:5px; font-size:15px; width:100%; box-sizing:border-box;">
